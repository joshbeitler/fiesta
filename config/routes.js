...
/ * *
  * (1) Core middleware *
  * Middleware included with `app.use`
is run first,
before the router * /
...
/ * *
  ...
  * In most cases,
these functions are actions inside of your controllers.*For convenience,
you can also connect routes directly to views or external URLs.*
  */
